...
Spatial and Map Search enables users to discover datasets based on a specific geographic area or time range. You can draw a polygon directly on the map or specify dates of interest to filter results and quickly locate the most relevant data.

On the [next page](../ndp-catalog/explore-data.md), you’ll find examples that demonstrate how to search for datasets, helping you explore and better understand the catalog’s features.